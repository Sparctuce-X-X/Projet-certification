...
interface AppleLogoProps extends IconProps {
  fill?: string;
}
...
/**
 * Apple logo — Sign in with Apple HIG requires white logo on black bg.
 * Source : public-domain Apple silhouette path (Font Awesome / simple-icons compat).
 */
export function AppleLogo({ size = 20, fill = "#FFFFFF" }: AppleLogoProps) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24">
      <Path
